...
public class Main {
    ...
    private static final Marker SEARCH_MARKER = MarkerManager.getMarker("INPUT_HISTORY");
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            try {
                ...
                LOGGER.info(SEARCH_MARKER,"Пользователь ввел маршрут от {} до {} ", from, to);
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            LOGGER.info(INPUT_ERRORS_MARKER, "Станция не найдена : {}", line);
